...
def solve():
    ...
    for i in range(9):
        for j in range(9):
            ...
            EntryList[i][j] = tk.Entry(
                root, width=3, state='disabled', textvariable=message, justify='center')
    ...
    for i in range(9):
        ...
        for j in range(9):
            if EntryList[i][j].get() != '':
                ...
                entry = tk.Entry(root, width=3, state='disabled',
                                 textvariable=message, justify='center')
